...
import com.example.freewill.databinding.FragmentSchedule2Binding
 ...
 * Use the [ScheduleFragment2.newInstance] factory method to
...
class ScheduleFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentSchedule2Binding.inflate(inflater)
        return binding.root
    }
    ...
    private fun readSchedule(user: String?) {
        ...
        referenceSchedule.child(user!!).child("Вівторок").get().addOnSuccessListener{
            if(it.exists())
            {
    ...
    companion object {
         ...
         * @return A new instance of fragment ScheduleFragment2.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ScheduleFragment2().apply {
