...
import com.example.freewill.databinding.FragmentEditScheduleTuesdayBinding

class EditSchedule_tuesday_Fragment : Fragment() {

    private lateinit var binding: FragmentEditScheduleTuesdayBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditScheduleTuesdayBinding.inflate(inflater)
        return binding.root
    }
    ...
    private fun updateShedule(monday: Day)
    {
        ...
        val ChangeDay = binding.tuesday.text.toString().trim()
